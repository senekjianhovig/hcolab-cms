...
<div class="ui pagination menu" role="navigation">
    ...
    @else
    <a class="icon item" href="javascript:;" data-target="{{$page->slug}}" onclick="changePage($(this) , '{{$table->currentPage()-1}}')" rel="prev"
    ...
    <a class="item active" href="javascript:;" data-target="{{$page->slug}}" onclick="changePage($(this) , '{{$page_number}}')" aria-current="page">{{
        $page_number }}</a>
    @else
    <a class="item" href="javascript:;" data-target="{{$page->slug}}" onclick="changePage($(this) , '{{$page_number}}')">{{ $page_number }}</a>
    @endif
    @endforeach
    @endif
    @endforeach
    ...
    <a class="icon item" href="javascript:;" data-target="{{$page->slug}}" onclick="changePage($(this) , '{{$table->currentPage()+1}}')" rel="next"
