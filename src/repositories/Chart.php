...
class Chart
{
    ...
    public function __construct()
    {
        foreach (func_get_args() as $arg) {
            ...
            $this->datasets[] = $arg['type'] == 'table' ? $this->getTable() : $this->prepareData();
        }
    ...
    public function getTable(){
        ...
        if(isset($options['order_by']['field'])){
            $model->orderBy($options['order_by']['field'] , isset($options['order_by']['direction']) && !empty($options['order_by']['direcion']) ? $options['order_by']['field'] : 'ASC');
        }
    ...
    {
        return view('CMSViews::chart.html', ['options' => $this->options]);
    }
    ...
    {
        return view('CMSViews::chart.javascript', ['options' => $this->options, 'datasets' => $this->datasets]);
    }
